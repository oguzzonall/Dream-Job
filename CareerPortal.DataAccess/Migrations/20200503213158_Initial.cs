        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    JobPostTitle = table.Column<string>(maxLength: 100, nullable: false),
                    JobPostDescription = table.Column<string>(nullable: false),
                    ...
                    JobPostStatusId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobPosts_Experiences_ExperienceId",
                        column: x => x.ExperienceId,
                        principalTable: "Experiences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobPosts_Genders_GenderId",
                        column: x => x.GenderId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobPosts_Regions_RegionId",
                        column: x => x.RegionId,
                        principalTable: "Regions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JobPosts_Sectors_SectorId",
                        column: x => x.SectorId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobPosts_RegionId",
                table: "JobPosts",
                column: "RegionId");

            migrationBuilder.CreateIndex(
                name: "IX_JobPosts_SectorId",
                table: "JobPosts",
                column: "SectorId");
